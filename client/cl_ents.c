...
//		state->pmove.pm_type = (pmtype_t)MSG_ReadByte (&net_message);
		byte_write(&state->pmove.pm_type, (pmtype_t)MSG_ReadByte (&net_message));
...
//		state->pmove.pm_time = MSG_ReadByte (&net_message);
		byte_write(&state->pmove.pm_time, MSG_ReadByte (&net_message));

	if (flags & PS_M_FLAGS)
//		state->pmove.pm_flags = MSG_ReadByte (&net_message);
		byte_write(&state->pmove.pm_flags, MSG_ReadByte (&net_message));
...
//		state->pmove.pm_type = PM_FREEZE;		// demo playback
		byte_write(&state->pmove.pm_type, PM_FREEZE);
