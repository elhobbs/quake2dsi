...
#ifdef BOXTESTED_BSP
	if (ds_boxtest(node->bt_minmaxs[0], node->bt_minmaxs[1], node->bt_minmaxs[2],
...
//	scaled_modelorg[2] = (short)(modelorg[2] * DS_MINI_GEOM_SCALE);
	...
	//ds_translatef(modelorg[0] * x_org, modelorg[1] * y_org, modelorg[2] * z_org);
...
//	
	...
	ds_polyfmt(0, 31, 0, POLY_CULL_FRONT);		//front and back
