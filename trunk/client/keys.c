...
// allocate memory for new binding
	l = strlen (binding);	
	new_char = (char *)Z_Malloc (l+1);
	strcpy (new_char, binding);
	new_char[l] = 0;
	keybindings[keynum] = new_char;	
}
...
//	printf("key %c, down %d, time %d, %08x\n", key, down, time, lr);
