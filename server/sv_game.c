...
//	import.error = PF_error;
	...
	import.BoxEdicts = (int (*) (vec3_t, vec3_t, edict_t **, int, int))SV_AreaEdicts;
	...
	import.ds_fclose = ds_fclose;
	import.ds_fopen = ds_fopen;
	import.ds_fseek = ds_fseek;
	import.ds_fread = ds_fread;
	import.ds_fwrite = ds_fwrite;
	import.ds_ftell = ds_ftell;
	
	import.ds_malloc = ds_malloc;
	import.ds_free = ds_free;
	//it's in itcm so we have to put a cast around it...for some reason
	import.ds_memset = (void (*)(void *, unsigned char, unsigned int))ds_memset;
	import.ds_strcpy = (void (*)(char *dest, char *src))ds_strcpy;
